...
Window
{
    ...
    {
        /*初始化列表*/
        buttonlist[0] = qpVoltage
        buttonlist[1] = temp_Comp
    ...
    Connections
    {
        ...
        onResultChanged:
        {
            ...
            var cmd = "update system_param_table set snapvalue = " + rootw.currentbutton.snap_value * rootw.currentbutton.gain + ",value = " + rootw.currentbutton.value * rootw.currentbutton.gain + " where description = '" + rootw.currentbutton.description + "'"
    ...
    //                        wrapMode: Text.WordWrap
                    ...
                    Rectangle
                    {
                        ...
                        CustomButton
                        {
                            ...
                            min_value: 1.0
                            gain: 10
                            description: qsTr("除气泵电压")
                            text: value

                            onClicked:
                            {
                                setParameterValue(description,max_value,min_value,1)
    ...
    {
        var cmd = "select * from system_param_table"
