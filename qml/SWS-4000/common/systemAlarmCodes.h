#ifndef SYSTEMALARMCODES_H
#define SYSTEMALARMCODES_H
...
{
    CONTINUE                                                             = 1,                     //持续报警
    INTERVAL_10                                                          = 10,                    //间隔10s
    INTERVAL_30                                                          = 30,                    //间隔30s
    INTERVAL_60                                                          = 60,                    //间隔60s
}systemAlarmIntervalType;

typedef enum
{
    SYSTEM_ALARM_DISABLE                                                 = 0,                     //不报警
    SYSTEM_ALARM_ENABLE                                                  = 1,                     //报警
}systemAlarmEnableType;
...
typedef enum
{
    ...
    BLINK_50                                                             = 1,                      //闪烁
    BLINK_100                                                            = 2,                      //常开
}systemAlarmLightBlinkType;

#endif // SYSTEMALARMCODES_H
