#ifndef POWERSYSTEMSIMULATION_H
#define POWERSYSTEMSIMULATION_H

#include "boardsimulationbase.h"
#include "common/publicdata.h"

class PowerSystemSimulation : public BoardSimulationBase
{
    Q_OBJECT
public:
    explicit PowerSystemSimulation(QObject *parent = nullptr);
